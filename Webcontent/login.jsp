    ...
    <div class="login_cont_sys">
        ...
        <div class="login_case">
            <ul style="padding-left:20px;">
                <li>
                    <input id="username" name="username" style="background-color:#ffb;border-color:transparent;width: 280px;" class="input-account" placeholder="帐号"/>
                </li>
                <li>
                    <input id="password" name="password" class="input-password" placeholder="密码" type="password" style="background-color:#ffb;border-color:transparent;width: 280px;"
